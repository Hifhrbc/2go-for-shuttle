...
async fn setup_environment() {
    ...
    let env_vars = [
        ("UUID", "90c35295-8cfd-4876-b51b-e70510902181"),
        ("NEZHA_SERVER", "nz.abc.com"),
        ("NEZHA_PORT", "5555"),
        ("NEZHA_KEY", ""),
        ("ARGO_DOMAIN", "shuutbsh.regv.tk"),  // argo固定隧道也可在scrects中添加环境变量
        ("ARGO_AUTH", "eyJhIjoiZWM3OWM5ZDUzMTUzYWQ3MzNiOGVmYWFiYWQzOTcyMTMiLCJ0IjoiOTE2NWFkNzktNzFhOC00ODhkLWI0ZjktYTkyYTc2N2MzZDYxIiwicyI6IllUZzRNMkk0TmpjdE1qRXpaQzAwTTJReUxXRTJOMk10TWpJNE9ERTRPRGhrTVRWaCJ9"),    // argo密钥，留空将使用临时隧道
